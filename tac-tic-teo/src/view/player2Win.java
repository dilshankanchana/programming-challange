 ...
 * @author HP
 */
public class player2Win extends javax.swing.JFrame {

    /**
     * Creates new form player2Win
     */
    BoardMultiPlayer b2;
    public player2Win() {
        initComponents();
    ...
    public player2Win(BoardMultiPlayer b2) {
        initComponents();
        this.b2 = b2;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/winner2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(player2Win.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
